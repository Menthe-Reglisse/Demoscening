...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    {
        vec3 backgroundCol =    vec3(0.9, 0.5, 0.7) * max(1.-floor(mod(iTime/2./PI,3.)),0.)
                             +  vec3(0.6, 0.8, 1.)   * max(1.-floor(mod(iTime/2./PI-1.,3.)),0.)
                             +  vec3(0.85, 0.85, 0.3)   * max(1.-floor(mod(iTime/2./PI-2.,3.)),0.);
